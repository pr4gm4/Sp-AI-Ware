...
def outGray():
    print("\nDalle informazioni fornite e' difficile stabilire con una buona probabilita' se il programma sia dannoso oppure no. Tuttavia poiche' i suoi dati binari sono stati segnalati, si provvedera' a categorizzare questo software come Grayware ovvero un software la cui pericolsita' e' dubbia\n")
